...
## Generated on : Mon Mar 04 16:54:12 2024
...
START_DIR                 = /Users/ozitommi/Documents/MATLAB/Higher\ Order\ Sychronization/algebraic_constraints_04-03-2024/algebraic-common-lines
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
SRCS = $(START_DIR)/codegen/lib/runADMM/rt_nonfinite.c $(START_DIR)/codegen/lib/runADMM/rtGetNaN.c $(START_DIR)/codegen/lib/runADMM/rtGetInf.c $(START_DIR)/codegen/lib/runADMM/runADMM_initialize.c $(START_DIR)/codegen/lib/runADMM/runADMM_terminate.c $(START_DIR)/codegen/lib/runADMM/sum.c $(START_DIR)/codegen/lib/runADMM/ADMM.c $(START_DIR)/codegen/lib/runADMM/kron.c $(START_DIR)/codegen/lib/runADMM/norm.c $(START_DIR)/codegen/lib/runADMM/xnrm2.c $(START_DIR)/codegen/lib/runADMM/svd.c $(START_DIR)/codegen/lib/runADMM/xzsvdc.c $(START_DIR)/codegen/lib/runADMM/eval_obj.c $(START_DIR)/codegen/lib/runADMM/estimate_W.c $(START_DIR)/codegen/lib/runADMM/runADMM.c $(START_DIR)/codegen/lib/runADMM/xaxpy.c $(START_DIR)/codegen/lib/runADMM/xrotg.c $(START_DIR)/codegen/lib/runADMM/div.c $(START_DIR)/codegen/lib/runADMM/runADMM_emxutil.c $(START_DIR)/codegen/lib/runADMM/runADMM_emxAPI.c
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o runADMM_initialize.o runADMM_terminate.o sum.o ADMM.o kron.o norm.o xnrm2.o svd.o xzsvdc.o eval_obj.o estimate_W.o runADMM.o xaxpy.o xrotg.o div.o runADMM_emxutil.o runADMM_emxAPI.o
