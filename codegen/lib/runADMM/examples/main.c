...
Change this value to the value that the application requires. */
  ...
  result->missing_mu = c_argInit_UnboundedxUnbounded_r();
  result->missing_tau1 = c_argInit_UnboundedxUnbounded_r();
  result->missing_tau2 = c_argInit_UnboundedxUnbounded_r();
  ...
  result->quad = c_argInit_UnboundedxUnbounded_r();
